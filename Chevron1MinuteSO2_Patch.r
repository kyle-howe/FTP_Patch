...
FTP_export_profile <- tb_FtpExportMonitor %>%
  filter(ProfileId == 6) %>% #This is the profile for the MoE
...
write.table(FINAL_ftp_AQ, file = "Chevron1MinuteSO2_patch.csv", sep = ",", col.names = FALSE, row.names = FALSE, quote = FALSE)

ftpUpload("Chevron1MinuteSO2_patch.csv", "sftp://DMZ\\KHowe:greaSebegone@sftp.metrovancouver.org/MetroVancouver/AQMS/MVAQDATAMIN/NONVERIFIED/Chevron1MinuteSO2_PATCH.csv")
#ftpUpload("Chevron1MinuteSO2_patch.csv", "sftp://DMZ\\KHowe:greaSebegone@sftp.metrovancouver.org/MetroVancouver/AQMS/KJH_Test/Chevron1MinuteSO2_PATCH.csv")
#ftpUpload("Chevron1MinuteSO2_patch.csv", "sftp://DMZ\\KHowe:greaSebegone@sftp.metrovancouver.org/MetroVancouver/AQMS/MVAQDATAMIN/NONVERIFIED/Chevron1MinuteSO2_DEV.csv")
